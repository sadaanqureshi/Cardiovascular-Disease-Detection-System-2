...
import { User, Lock, Mail, Phone, GraduationCap, Edit2, ShieldCheck } from 'lucide-react';
...
export default function RadiologistProfile() {
  ...
  const [userData, setUserData] = useState({
    email: 'j.wong@hospital.com',
    fullName: 'Dr. Jennifer Wong',
    contact: '(555) 111-2222',
    qualification: 'MD, Board Certified Radiologist'
  });

  const profileFields = [
    { name: 'fullName', label: 'Full Name', type: 'text', placeholder: 'Dr. Jennifer Wong', required: true, defaultValue: userData.fullName },
    { name: 'email', label: 'Email Address', type: 'email', placeholder: '(555) 111-2222', required: true, defaultValue: userData.email },
    { name: 'contact', label: 'Contact Number', type: 'text', placeholder: '(555) 111-2222', required: true, defaultValue: userData.contact },
    { name: 'qualification', label: 'Qualification / Designation', type: 'text', placeholder: 'MD, Radiologist', required: true, defaultValue: userData.qualification },
  ];
    ...
    <div className="flex bg-slate-50 min-h-screen font-sans">
      ...
      <main className="w-full lg:ml-64 p-4 sm:p-6 lg:p-8 transition-all duration-300">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 h-fit hover:shadow-md transition-shadow duration-300">
                ...
                <div className="p-6 bg-slate-50/80 rounded-2xl border border-slate-100">
                    ...
                    <p className="text-xs text-slate-400">
                        Last changed <span className="text-slate-700 font-bold">3 months ago</span>. 
        ...
        <GenericFormModal
            ...
            onSubmit={(data: any) => { setUserData({...userData, ...data}); setIsProfileModalOpen(false); }}
        ...
        <GenericFormModal
            ...
            onSubmit={() => setIsPasswordModalOpen(false)}
